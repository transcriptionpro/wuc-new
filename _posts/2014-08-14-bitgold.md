...
<tr><td>Users can send and receive gold as payment to and from any BitGold user or seller for free.<p>Gold can be sent as payment to non-BitGold users with email or mobile phone.<p>This does seem like an interesting use case in the Information Age.</td><td><img src="/images/bitgold-iphone-app.jpg"></td></tr>
