...
<tr><td style="text-align: center;">Users can send and receive gold as payment to and from any BitGold user or seller for free. Gold can be sent as payment to non-BitGold users with email or mobile phone.</td><td style="text-align: center;"><img src="/images/bitgold-iphone-app.jpg"></td></tr>
<tr><td style="text-align: center;">Users can spend gold with a BitGold prepaid debit card which is accepted globally anywhere that processes major credit cards and includes ATM machines to withdraw local currency.</td><td style="text-align: center;"><img src="/images/bitgold-debit-card.jpg"></td></tr>
<tr><td style="text-align: center;">The 10 gram BitGold gold cubes are worth approximately US$380 and can be redeemed on the BitGold platform.</td><td style="text-align: center;"><img src="/images/bitgold-10gram-cubes.jpg"></td></tr>
</table>
### Is Bitgold safe?
