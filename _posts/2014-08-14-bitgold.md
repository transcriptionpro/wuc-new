...
<tr><td style="text-align: center;">Users can send and receive gold as payment to and from any BitGold user or seller for free. Gold can be sent as payment to non-BitGold users with email or mobile phone.</td><td><img src="/images/bitgold-iphone-app.jpg"></td></tr>
<tr><td style="text-align: center;">Users can spend gold with a BitGold prepaid debit card which is accepted globally anywhere that processes major credit cards and includes ATM machines to withdraw local currency.</td><td><img src="/images/bitgold-debit-card.jpg"></td></tr>
<tr><td VALIGN = Middle Align = Left>The 10 gram BitGold gold cubes are worth approximately US$380 and can be redeemed on the BitGold platform.</td><td><img src="/images/bitgold-10gram-cubes.jpg"></td></tr>
</table>
### Is Bitgold safe?
