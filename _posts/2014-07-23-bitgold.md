...
<p>GOoldMoney and Bitgold are the same company. Bitgold is a brand new platform for that intends to offer gold payments to customers. It is publicly traded on the TSX Venture exchange in Canada with the stock ticker symbol (<a href="http://web.tmxmoney.com/quote.php?qm_symbol=XAU:TSV">XAU:TSV</a>).
